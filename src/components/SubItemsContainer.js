  ...
  let [subItems, SetSubItems] = useState([
    {
      text: 'Overview',
      header:
        'OLink Solutions is here to make a difference through technology.',
      content:
        'Leading the way in innovation for over 10 years, we build greater futures for businesses across multiple industries and 50 countries.',
    },
    {
      text: 'Industries',
      items: [
